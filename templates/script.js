...
5G is in the testing phase on giffgaff. If all goes to plan, we might see it switch on at the end of 2020 or early 2021. There's a small selection of 5G enabled devices available for sale from giffgaff.
...
An issue with using the MMS (picture message) service was recognised by giffgaff and you can read more about it on the [Service Updates page](https://community.giffgaff.com/d/33109663-resolved-issues-using-mms-23-april-2020). Most of these cases are due to an incorrect "MMSC address" in your phone's settings.
...
A recent update to the way balance notifications are provided means that automated devices (like gates or alarms) may start forwarding these messages to your phone.
...
5G has relaunched on giffgaff. Please see [this post](https://community.giffgaff.com/d/33214098-5g-on-giffgaff-is-available-now) for more details.
