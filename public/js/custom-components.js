          ...
          <nav class="gg-c-website-header__lrg-screen-nav">
            ...
            ${menuItems
              ...
              <li class="gg-c-website-header__lrg-screen-item">
                <a href="${
                  items.link
                }" class="gg-c-website-header__lrg-screen-link">
    ...
    ${menuItems
      ...
      <section id="unofficial">
        <div class="gg-o-page-section">
          <strong>Please note:</strong> this website is run by members of the giffgaff community and is not to be confused with <a class="gg-u-link" href="https://giffgaff.com/" target="_blank" rel="noreferer noopener">giffgaff.com</a>
        </div>
      </section>
        `;
  }
...
class ggFooter extends HTMLElement {
  ...
  <div class="gg-o-page-section">
    <p class="gg-u-text-speak">
      This page is run by members of the giffgaff community and does not
